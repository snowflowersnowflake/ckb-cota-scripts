...
pub const REGISTRY_TYPE_CODE_HASH: [u8; 32] = [
   243, 203, 255, 253,  75,  30, 160,  88, 156,  37,  90, 139, 32, 165, 158,  68,
   15, 247,  40,  52, 161, 143,  89,  63, 58, 129, 161,  86,  85, 241, 118, 253

];

pub const COTA_TYPE_CODE_HASH: [u8; 32] = [
    29, 239,  55, 101, 172, 177, 221, 107, 228, 171,  42, 104,  75,  93,  44,  91,
    41, 164, 181, 192, 141, 174, 114, 229, 146,  76,  65, 206, 246, 187,  36, 186
];
